...
* Allows direct loading of Version 4
* Allows for custom taxonomy

= 3.5.0 =
* Choose the category and post taxonomy you want to sync, in case you are using something other than the standard structure.
